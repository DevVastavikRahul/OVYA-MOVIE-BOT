...
async def VastavikXBotz_start():
    print('Initalizing Your Bot!')
    await vastavik.start()
    bot_info = await vastavik.get_me()
    vastavik.username = bot_info.username
    ...
    me = await vastavik.get_me()
    temp.ME = me.id
    temp.U_NAME = me.username
    temp.B_NAME = me.first_name
    temp.B_LINK = me.mention
    vastavik.username = '@' + me.username
    vastavik.loop.create_task(check_expired_premium(vastavik))
    ...
    await vastavik.send_message(chat_id=LOG_CHANNEL, text=script.RESTART_TXT.format(temp.B_LINK, today, time))
